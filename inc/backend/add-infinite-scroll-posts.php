				         ...
				         <td>
				         	 <div class="ssp-field">
                                <?php $post_limit = ( isset( $options['post_limit'] ) ) ? $options['post_limit'] : ''; ?>
                                  <input type="number" min="0" name="post_limit"  value="<?php echo esc_attr( $post_limit ); ?>"/>
                                             ...
                                             foreach ($image_sizes as $size_name => $key): 
                                              ?>
                                               ...
                                               <?php endforeach; 
                                                ...
                                                <p class="description"><?php _e('Choose the size of the image you want show for all the next posts after scroll.','smart-scroll-posts');?></p>
                               </div>
				          </td>
				       </tr>
				        <tr> 
